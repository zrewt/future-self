...
export default function Log() {
  ...
  const {
    user, profile, todayLog, earnedAchievements,
    loadUserData, setTodayLog, setProfile,
  } = useUserStore()
  ...
  if (success !== null) {
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center animate-slide-up px-4">
        <div className="glass-card p-10 text-center w-full max-w-sm">
          ...
          {success.honestyMessage && (
            <div className="mt-4 flex items-center justify-center gap-2 bg-teal/10 border border-teal/20 rounded-2xl px-4 py-2.5">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="glass-card p-5">
          ...
          <input
            ...
            onChange={(e) => updateField('focus_minutes', Number(e.target.value))}
            className="input-field"
          />
        ...
        <div className="glass-card p-5">
          ...
          <input
            ...
            onChange={(e) => updateField('reading_minutes', Number(e.target.value))}
            className="input-field"
          />
        ...
        <div className="glass-card p-5">
          ...
          <input
            ...
            onChange={(e) => updateField('meditation_minutes', Number(e.target.value))}
            className="input-field"
          />
        ...
        <div className="glass-card p-5">
          ...
          <div className="flex flex-wrap gap-1.5 justify-between">
            {MOOD_EMOJIS.map((emoji, i) => (
              <button
                key={i + 1} type="button"
                onClick={() => updateField('mood', i + 1)}
                className={`text-xl w-9 h-9 rounded-xl flex items-center justify-center ${form.mood === i + 1 ? 'bg-primary-50 ring-2 ring-primary' : 'opacity-50'}`}
              >
                {emoji}
              </button>
            ))}
