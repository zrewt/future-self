...
// For numeric inputs that default to 0: render 0 as an empty field so typing
// new digits replaces it cleanly instead of appending to a visible "0"
// (e.g. typing "150" landing as "0150"). An emptied field maps back to 0.
